    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container px-4 text-center text-white">
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 text-gray-100">
              Discover thoughtfully designed, fully serviced offices that work
              for teams of every size. With flexible rental terms and
              hassle-free setup, you can stay focused on what matters
      ...
      <section className="py-24 bg-[#fbf7f2]">
        <div className="container px-4 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Access office spaces across our international network. Simply choose
            your preferred city or area to explore available options and
            pricing.
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              From short stays to long-term commitments, our customisable office
              spaces can be rented by the hour, day, month, or year—giving you
              freedom as your business evolves.
            </p>
        ...
        <div className="container px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-4">
              Choose the Right Office for You
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                ...
                <li className="flex items-center gap-2">
                  • Solo professionals to large teams
                </li>
                <li className="flex items-center gap-2">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">
                  • Tailored layouts and branding
                </li>
                <li className="flex items-center gap-2">
                  • Adaptable lease options
                </li>
                <li className="flex items-center gap-2">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 flex-grow">
                On-demand workspace whenever you need a professional
                environment.
              </p>
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="max-w-xl text-center md:text-left">
                ...
                <p className="text-gray-300 text-lg mb-8">
                  Schedule a one-to-one consultation with our workspace
                  specialists. Our advisors are available globally to help you
        ...
        <div className="container px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your office comes fully supported, so you can get to work
              ...
              <div key={i} className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Everything from basic utilities to high-end connectivity is
                    included in your simple pricing.
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-8">
                Office Space That <br /> Adapts as You Grow
              </h2>
              <p className="text-xl text-gray-300 mb-10 leading-relaxed">
                Your workspace should change as your business does. We offer
                flexible terms with minimal risk.
              </p>
              <div className="space-y-6">
                {[
      ...
      <section className="py-24 bg-white text-center">
        <div className="container px-4 max-w-4xl">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Create a workspace that reflects your brand and culture. From floor
            plans to finishes and signage, every detail can be customised.
          </p>
            ...
            {[
              {
                ...
                desc: "Choose your location, office size, and preferred layout.",
                icon: MapPin,
              },
              {
                title: "Personalise",
                desc: "Work with our design team—or let us handle everything for you.",
                icon: Layout,
              },
              {
                title: "Move In",
                desc: "Once your agreement is complete, your office is ready.",
                icon: DoorOpen,
              },
            ].map((step, i) => (
              <div
              ...
              >
                ...
                <h4 className="text-xl font-bold text-[#4b3624] mb-4">
                  {step.title}
                </h4>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="container px-4 text-center max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#4b3624] mb-8">
            Serviced Offices for Every Business Size
          </h2>
          ...
          <p className="text-lg text-gray-600 mb-10">
            From ambitious startups to global enterprises, our serviced offices
            support businesses at every stage. Reception services, cleaning, and
