    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container px-4 text-center text-white">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Virtual Offices That Give You <br className="hidden md:block" /> a Real Business Presence
            </h1>
            <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 text-gray-100 leading-relaxed">
              Create a professional presence for your business anywhere in the world—without the cost or commitment of a physical office.
            </p>
      ...
      <section className="py-24 bg-[#fbf7f2]">
        <div className="container px-4 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-6">Virtual Office, Real Impact</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
            Whether you need a simple business address or a more complete virtual setup, our flexible packages let you choose the level of presence that suits your business.
          </p>
      ...
      <section className="py-24 bg-white">
        <div className="container px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-4">Choose the Right Package</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 flex-grow">
                Establish your business with a professional address in a prime location.
              </p>
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">• Prime business address</li>
                <li className="flex items-center gap-2">• Use on websites & stationery</li>
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-lg border-2 border-[#d4a574]/20 flex flex-col h-full relative group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 flex-grow">
                Our most popular option for growing businesses needing receptionist support.
              </p>
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">• Prestigious business address</li>
                <li className="flex items-center gap-2">• Professional call answering</li>
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 flex-grow">
                The most comprehensive virtual solution with physical workspace access.
              </p>
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">• All Virtual Office benefits</li>
                <li className="flex items-center gap-2">• Access to meeting rooms</li>
          ...
          <div className="bg-[#4b3624] rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="max-w-xl text-center md:text-left">
                <h2 className="text-3xl md:text-5xl font-bold mb-6">Need Some Expert Advice?</h2>
                <p className="text-gray-300 text-lg mb-10 leading-relaxed">
                  Arrange a one-to-one call with a virtual office specialist. Our advisors are available worldwide to help you find the right fit.
                </p>
           ...
           <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                 ...
                 <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                    A virtual office allows you to establish a presence in any city, while working from home or remotely. You gain the benefits of a professional address without the overheads.
                 </p>
                 <div className="space-y-6">
                    {[
                      { title: "Prestigious locations", desc: "Build credibility with an address in key business districts." },
                      { title: "Lower costs", desc: "Avoid rent, utilities, and expensive staffing expenses." },
                      { title: "Company registration", desc: "Use your virtual address to register your business legally." },
                      { title: "Global expansion", desc: "Enter new markets instantly with a local presence." }
                    ].map((item, i) => (
              ...
              <div className="relative h-[600px] rounded-[3rem] overflow-hidden shadow-2xl">
                 <Image src="/virtual-offices3.jpeg" alt="Global Presence" fill className="object-cover" />
              </div>
           </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#4b3624] text-white">
        <div className="container px-4">
           <div className="text-center mb-16">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">Virtual offices support businesses and professionals at every stage of their growth journey.</p>
           </div>
           <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: "Startups", desc: "Launch with a credible, professional image from day one.", icon: Target },
                { title: "Small Businesses", desc: "Expand internationally without major investment.", icon: Briefcase },
                { title: "Large Enterprises", desc: "Establish satellite locations quickly and easily.", icon: Building2 },
                { title: "Freelancers", desc: "Work remotely while protecting privacy and managing mail.", icon: User }
              ].map((item, i) => (
      ...
      <section className="py-24 bg-white">
        <div className="container px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Every plan includes essential business support to keep you connected.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              { title: "Professional address", icon: MapPin, desc: "A recognised address for official and marketing use." },
              { title: "Mail handling", icon: Mail, desc: "Secure handling and forwarding options for your correspondence." },
              { title: "Reception support", icon: Users, desc: "Experienced receptionists to greet your calls and guests." },
              { title: "Business discounts", icon: CreditCard, desc: "Exclusive invitations to networking and professional events." },
              { title: "Airport lounge access", icon: Plane, desc: "Discounted access for professionals on the move." },
              { title: "Workspace credits", icon: Briefcase, desc: "On-demand access to meeting rooms and physical office space." },
            ].map((item, i) => (
           ...
           <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 md:order-2">
                 ...
                 <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    Need help managing calls? Add a local phone number with professional call handling. Never miss an important opportunity again.
                 </p>
                 <div className="space-y-4 mb-10">
                    <div className="flex items-center gap-4">
                       <CheckCircle2 className="w-5 h-5 text-[#d4a574]" />
                       <span className="font-medium text-[#4b3624]">Calls answered in your company name</span>
                    </div>
                    <div className="flex items-center gap-4">
                       <CheckCircle2 className="w-5 h-5 text-[#d4a574]" />
                       <span className="font-medium text-[#4b3624]">Messages taken or forwarded to you</span>
                    </div>
                    <div className="flex items-center gap-4">
                       <CheckCircle2 className="w-5 h-5 text-[#d4a574]" />
                       <span className="font-medium text-[#4b3624]">Local business number included</span>
                    </div>
                 </div>
      ...
      <section className="py-24 bg-white text-center">
         <div className="container px-4 max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-8">Virtual Offices That Move With Your Business</h2>
            <p className="text-xl text-gray-600 mb-12">
               As your business grows, your virtual office can grow with it. Speak with our team to create a bespoke package that fits your expansion plans.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
               <Button size="lg" className="bg-[#d4a574] text-white hover:bg-[#b58b61] rounded-full px-12 py-7 text-lg shadow-xl">
                  Enquire now
               </Button>
