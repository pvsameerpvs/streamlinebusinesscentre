    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container px-4 text-center text-white">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 text-gray-200 leading-relaxed">
              Step into inspiring, open-plan coworking environments created to
              help you work better and connect more. Our thoughtfully designed
              shared workspaces bring together ambitious professionals,
      ...
      <section className="py-24 bg-[#fbf7f2]">
        <div className="container px-4 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
            With access to a global coworking network, you can work from
            locations that suit your schedule and lifestyle. Search by city or
            area to explore availability and pricing.
          </p>
        ...
        <div className="container px-4 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Whether you need a desk for a few hours or a regular place to
              work, our coworking options are built for flexibility. Choose from
              hot desks or dedicated desks across thousands of locations
              worldwide.
            </p>
        ...
        <div className="container px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">
                  • Reserved workspace just for you
                </li>
                <li className="flex items-center gap-2">
                  • Business address and storage
                </li>
                <li className="flex items-center gap-2">
                  • Consistency for individuals/teams
                </li>
              </ul>
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 flex-grow">
                Drop in and work whenever you need to in a professional
                environment.
              </p>
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">
                  • Hot desk access by hour/day
                </li>
                <li className="flex items-center gap-2">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 flex-grow">
                Work more regularly with flexible monthly access to any
                location.
              </p>
              <ul className="text-sm text-gray-500 space-y-2 mb-8 border-t border-gray-50 pt-6">
                <li className="flex items-center gap-2">
                  • 5, 10, or unlimited days
                </li>
                <li className="flex items-center gap-2">
                  • Simple, flexible payment options
                </li>
                <li className="flex items-center gap-2">
                  • Hot desk as often as you need
                </li>
              </ul>
              <div className="flex flex-col gap-3">
                <Button className="w-full bg-[#4b3624] text-white rounded-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="max-w-xl text-center md:text-left">
                ...
                <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                  Speak directly with a coworking specialist to find the right
                  solution for your business. Our advisors are available
                  worldwide.
                </p>
        ...
        <div className="container px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              When you choose coworking with us, your workspace comes fully
              supported—so you can focus on productivity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              {
                title: "Friendly reception teams",
                icon: Heart,
                desc: "A warm welcome for you and your guests every day.",
              },
              {
                title: "Meeting rooms on-demand",
                icon: Calendar,
                desc: "Book private spaces whenever you need to hold a session.",
              },
              {
                title: "Business-grade Wi-Fi",
                icon: Wifi,
                desc: "Reliable connectivity, shared printers, and IT support.",
              },
              {
                title: "Comfortable lounges",
                icon: Coffee,
                desc: "Breakout spaces designed for relaxation and casual chat.",
              },
              {
                title: "Easy app bookings",
                icon: Smartphone,
                desc: "Manage your bookings and account smoothly via our app.",
              },
              {
                title: "4,000+ Locations",
                icon: Globe,
                desc: "Access our extensive global network whenever you travel.",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="group p-8 rounded-2xl border border-gray-50 hover:bg-[#fbf7f2] transition-colors duration-300"
              >
                ...
                <h4 className="text-lg font-bold text-[#4b3624] mb-3">
                  {feature.title}
                </h4>
      ...
      <section className="py-24 bg-[#4b3624] text-white">
        <div className="container px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-8">
            Coworking Where You Need It
          </h2>
          <p className="text-xl text-gray-300 mb-12 max-w-4xl mx-auto">
            Our extensive global network means there’s always a workspace
            nearby—whether you’re at home, travelling, or meeting clients.
          </p>
          ...
          <Button
            size="lg"
            className="bg-[#d4a574] hover:bg-[#c49665] text-white rounded-full px-12"
          >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-8">
                Coworking for Every Business Size
              </h2>
              <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                Coworking works for everyone—from solo founders to global
                enterprises. All backed by professional on-site support,
              ...
              <div className="space-y-8">
                {[
                  {
                    title: "Startups",
                    text: "Benefit from affordable space and networking opportunities to kickstart your journey.",
                  },
                  {
                    title: "Growing Companies",
                    text: "Reserve dedicated desks across locations as your team expands.",
                  },
                  {
                    title: "Multinational Teams",
                    text: "Enjoy seamless access worldwide, ensuring consistency for your global workforce.",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#4b3624] text-xl mb-1">
                        {item.title}
                      </h4>
        ...
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-[3rem] overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-500">
              ...
              <div className="p-10">
                <h3 className="text-3xl font-bold text-[#4b3624] mb-4">
                  Hot Desk Anytime
                </h3>
                <p className="text-gray-600 mb-8 leading-relaxed">
                  For total freedom, drop into a coworking space and hot desk
                  whenever it suits you. It’s a flexible, cost-effective way to
                  work.
                </p>
                <Link href="/hot-desks" className="block w-full">
                  <Button
                    variant="outline"
                    className="border-[#4b3624] text-[#4b3624] w-full py-6 rounded-2xl group"
                  >
                    Explore Hot Desking{" "}
            ...
            <div className="bg-white rounded-[3rem] overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-500">
              ...
              <div className="p-10">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Prefer consistency? Choose a dedicated desk in a shared
                  workspace. Secure locker for personal items and all the
                  benefits of coworking.
                </p>
                <Link href="/dedicated-desks" className="block w-full">
                  <Button
                    variant="outline"
                    className="border-[#d4a574] text-[#d4a574] hover:bg-[#d4a574] hover:text-white w-full py-6 rounded-2xl group"
                  >
                    Explore Dedicated Desks{" "}
                    <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="container px-4 text-center max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-8">
            Coworking That Helps Your Business Grow
          </h2>
          <p className="text-lg text-gray-600 mb-12">
            Our coworking spaces are home to a diverse community of
            professionals and businesses. By joining, you gain access to more
            than just a desk—you become part of a global ecosystem.
          </p>
          <div className="grid sm:grid-cols-2 gap-8 text-left mb-16">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-4 p-4 rounded-2xl bg-[#fbf7f2]"
              >
