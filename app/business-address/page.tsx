        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container px-4 text-center text-white">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Business Address Solutions <br className="hidden md:block" /> That
              Build Credibility
            </h1>
            <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 text-gray-100 leading-relaxed">
              Establish your business in a recognised, prestigious
              location—without the cost of renting a physical office. Enhance
              your brand image, protect your privacy, and register your company.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-sm text-gray-500 mb-6 flex-grow">
                Prime office address for marketing and correspondence. Ideal for
                remote businesses.
              </p>
              ...
              <Link href="/business-address">
                <Button
                  variant="ghost"
                  className="text-[#d4a574] font-bold p-0 justify-start hover:bg-transparent hover:text-[#4b3624]"
                >
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-sm text-gray-500 mb-6 flex-grow">
                Professional call handling in your company name. Local phone
                number included.
              </p>
              <ul className="text-xs text-gray-400 space-y-2 mb-8">
            ...
            <div className="bg-white p-8 rounded-[2rem] border-2 border-[#d4a574]/20 flex flex-col h-full group hover:shadow-xl transition-all duration-300 relative">
              ...
              <p className="text-sm text-gray-500 mb-6 flex-grow">
                Prestigious address plus virtual receptionist and global lounge
                network access.
              </p>
              <ul className="text-xs text-gray-400 space-y-2 mb-8">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 flex flex-col h-full group hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-sm text-gray-500 mb-6 flex-grow">
                Our most comprehensive package. Includes meeting rooms and
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[600px] rounded-[3rem] overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-10 right-10 bg-white/90 backdrop-blur-md p-6 rounded-3xl shadow-xl border border-[#d4a574]/20 hidden md:block">
                <div className="text-3xl font-bold text-[#4b3624] mb-1">
                  4,000+
                </div>
                <div className="text-xs font-bold text-[#d4a574] uppercase tracking-widest">
                  Global Locations
                </div>
              </div>
            </div>
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Establish a local or international presence without the burden
                of leasing office space. Ideal for home-based businesses,
                startups, and companies expanding into new markets.
              </p>
              ...
              <Button
                size="lg"
                className="bg-[#4b3624] text-white rounded-full px-12 h-16 shadow-xl"
              >
        ...
        <div className="container px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Your Business Address plan opens the door to a full range of
              support services.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: MapPin,
                desc: "Prime address for your official and marketing materials.",
              },
              {
                title: "On-site Support",
                icon: Users,
                desc: "Dedicated support from our experienced local teams.",
              },
              {
                title: "Reception Staff",
                icon: Users,
                desc: "Front-of-house staff to welcome any visitors to the centre.",
              },
              {
                title: "Mail Handling",
                icon: Mail,
                desc: "Secure mail handling and forwarding options (additional fees may apply).",
              },
              {
                title: "Community Events",
                icon: Globe,
                desc: "Invitations to professional networking and community sessions.",
              },
              {
                title: "Lounge Access",
                icon: Target,
                desc: "Discounted access to airport lounges worldwide via our network.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] backdrop-blur-sm group hover:bg-white/10 transition-colors"
              >
          ...
          <div className="bg-[#fbf7f2] rounded-[4rem] p-12 md:p-20 flex flex-col lg:flex-row items-center justify-between gap-12 group">
            <div className="max-w-xl text-center lg:text-left">
              <h2 className="text-3xl md:text-5xl font-bold text-[#4b3624] mb-6">
                Need More Than Just an Address?
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Upgrade to a Virtual Office for receptionist services,
                professional call handling, and on-demand access to meeting
                rooms and private offices.
              </p>
              <Button
                size="lg"
                className="bg-[#d4a574] hover:bg-[#c39665] text-white rounded-full px-10 h-16 shadow-xl"
              >
        ...
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                If managing calls is your main priority, our service ensures you
                never miss an important conversation. Professional,
              ...
              <div className="space-y-6 mb-10 text-[#4b3624] font-medium">
                <div className="flex items-center gap-4">
                  ...
                  <span>
                    Calls answered professionally using your company name
                  </span>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle2 className="w-5 h-5 text-[#d4a574]" />
              ...
              <Button
                asChild
                variant="outline"
                className="border-[#4b3624] text-[#4b3624] rounded-full px-8 py-6 h-14 font-bold hover:bg-[#4b3624] hover:text-white transition-all active:scale-95"
              >
                <a
                  href="https://calendly.com/streamlinebusinesscenter-sales/30min"
                  target="_blank"
      ...
      <section className="py-24 bg-[#4b3624] text-white text-center">
        <div className="container px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-400 mb-12">
            Establish your brand today with a prestigious business address. Join
            thousands of location-independent businesses.
          </p>
          <div className="flex flex-col gap-3 mb-12">
            <p className="text-xs font-bold text-[#d4a574] uppercase tracking-[0.3em]">
              Call directly to find the best rate
            </p>
            <a
              href="tel:+971505229908"
              className="text-4xl md:text-6xl font-black hover:text-[#d4a574] transition-colors"
            >
              +971 505229908
            </a>
          </div>
