  ...
  return (
    <section className="relative bg-[#fffbf6]">
      ...
      <div className="relative h-[800px] w-full bg-[#151110] overflow-hidden">
        ...
        {/* Hero content */}
        <div className="container relative z-10 flex h-full flex-col items-center justify-center pb-32 text-center">
          <h1 className="max-w-4xl text-5xl font-normal leading-tight tracking-tight text-white md:text-6xl lg:text-7xl">
      ...
      {/* Floating Search Card – now above hero + cream strip */}
